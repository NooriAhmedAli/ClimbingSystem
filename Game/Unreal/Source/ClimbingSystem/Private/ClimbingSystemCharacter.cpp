	...
	: Super(ObjectInitializer.SetDefaultSubobjectClass<UCustomCharacterMovementComponent>(ACharacter::CharacterMovementComponentName))
{
	...
	GetCharacterMovement()->Velocity = FVector3d(1.0f, 1.0f, 1.0f);
...
void AClimbingSystemCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(ClimbAction, ETriggerEvent::Triggered, this, &AClimbingSystemCharacter::Climb);
		EnhancedInputComponent->BindAction(CancelClimbAction, ETriggerEvent::Triggered, this, &AClimbingSystemCharacter::CancelClimb);
		//EnhancedInputComponent->BindAction("Cancel Climb", IE_Released, this, &AClimbingSystemCharacter::CancelClimb);
...
{
	/*if (GEngine) {
		GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, TEXT("This is an on screen message! Climb"));
	}*/
...
{
	/*if (GEngine) {
		GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Red, TEXT("This is an on screen message! Cancel"));
	}*/
